...
const UrlEncoderDecoder: React.FC = () => {
    ...
    const handleCopy = (type: 'decoded' | 'encoded') => {
        const textToCopy = type === 'decoded' ? decodedUrl : encodedUrl;
    ...
    return (
        <div className="max-w-7xl mx-auto">
            <h2 className="text-3xl font-bold mb-6 text-white">URL Encoder / Decoder</h2>
            <div className="bg-gray-800 p-4 sm:p-6 rounded-lg shadow-2xl border border-gray-700">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        <label htmlFor="decoded-url" className="block text-sm font-medium text-gray-300 mb-2">Decoded URL</label>
                        <textarea
                            id="decoded-url"
                            value={decodedUrl}
                    ...
                    <div>
                        <label htmlFor="encoded-url" className="block text-sm font-medium text-gray-300 mb-2">Encoded URL</label>
                        <textarea
                            id="encoded-url"
                            value={encodedUrl}
